//
//  ItineraryPhotosViewController.m
//  Flickr
//
...
#import "ItineraryPhotosViewController.h"
#import "Photo.h"
#import "PictureViewController.h"

@implementation ItineraryPhotosViewController
...
- (void)setupFetchedResultsController
{
    ...
    request.predicate = [NSPredicate predicateWithFormat:@"location.title = %@", self.location.title];
...
{
    static NSString *CellIdentifier = @"locationVacationPhotos";
